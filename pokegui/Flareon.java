...
public class Flareon extends Eevee implements FireType {
   ...
   public Flareon() {
      super("Flareon", "Flareon", 136, FIRE_COLOR, 0.9, 25.0, FIRE_TYPE, BASE_ATTACK_POWER, 
   ...
   */
   public Flareon(String name) {
      super("Flareon", name, 136, FIRE_COLOR, 0.9, 25.0, FIRE_TYPE, BASE_ATTACK_POWER, 
            BASE_DEFENSE_POWER, BASE_STAMINA_POWER);
      chooseFastAttack();
      chooseSpecialAttack();
   }
   ...
   /**
   * Firetype specific fast attack chooser.
