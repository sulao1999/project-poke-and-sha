...
* Dual-type Fire implements two type interfaces
* Parent class to Charmaleon
* @author Lana Kawauchi
* @version 1.0
* @since 02/18/2020
*/
public class Charmander extends Pokemon implements FireType {
   ...
   */
   ...
   /**
   * Fire type specific fast attack set.
   ...
   */
   ...
   /**
    * Fire type specific special attack set.
