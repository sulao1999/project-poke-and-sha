...
* Dual-type Normal implements type interfaces
...
public class Eevee extends Pokemon implements NormalType {
   ...
   *@param type1 The Pokemon's type
   ...
   */
   protected Eevee(String species, String name, int num, String color,
       double ht, double wt, String type1, int baseAttackPwr, int baseDefensePwr, 
       int baseStaminaPwr) {
